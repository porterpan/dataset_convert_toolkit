...
class LabelmeJson2voc:
    def __init__(self, args):
        ...
        self.rectangle_xml_files=[x for x in lableme_rectangle_xml_file_list if ".json" in x]
    ...
    def convert(self):
        ...
        for rectangle_xml_file in self.rectangle_xml_files:
            inputVocLabelXml = os.path.join(self.rectangle_xml_files, rectangle_xml_file)
    ...
    def rectangelVoc2yolo(self, input_xml, out_yoloFile):        
        ...
        for obj in data.iter('object'):
            ...
            if self.class_name.has_key(cls) or int(difficult) == 1:
                continue
            cls_id = self.class_name[cls]
